...
public class Oni extends Inimigo{
    ...
    private static String link = "https://forgottenrealms.fandom.com/wiki/Oni";
    private Oni(String nome, double vida, int dadoAtaque, int dadoDano, int forca, int reflexos, int constituicao, int agilidade, int valor,String link) {
        super (nome, vida, dadoAtaque, dadoDano, forca, reflexos, constituicao, agilidade, valor,link);
    }

    public static void criarInimigo() {
        double vida = calcularVida();
        new Oni(nome, vida, dadoAtaque, dadoDano, forca, ref, con, agi,valor,link);
    }
